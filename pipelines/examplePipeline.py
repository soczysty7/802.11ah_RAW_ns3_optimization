...
contentions = [1, 5]
numberOfStations = range(10, 60, 10)
rawObj = gr.staticDictGen(numberOfStations, False, contentions, 2)
plot_xAxis = [0, 60]
...
simName = "example_slots_saturation"

outputResultsDir = '/home/soczysty7/magister_ludi/examplePipelineResults/'
...
class RunSimulations(luigi.Task):
    ...
    def run(self):
        simLchrr = sm(dirWithNS3_ahClone, resultsOfSim, rawObj, 
            beaconIntervals,  distanceFromAP, payloadSize, 1)
