    ...
    def makePlot(self, pathList, metric):
        ...
        for idx, p in enumerate(self.subPaths):
            ...
            for j in range(0, len(frames)):
                ...
                elif (len(frames[j]['TrafficString'][0]) == 81): # 3 cyfrowa liczba stacji
                    i=frames[j]['TrafficString'][0][-15:-11]
